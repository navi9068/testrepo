...
$loadvideos=$_SESSION['viewersids'];

	$sql = "SELECT v.*,m.user_image FROM video as v inner join myguests as m on v.user_email=m.email where v.id NOT IN (".$loadvideos.");";
...
if ($result->num_rows > 0) {
  ...
  $_SESSION['viewersids']=implode(',',$viewdsvideosar);
  $_SESSION['viewersids']=$loadvideos.','.implode(',',$viewdsvideosar);
